...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _request_result_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../request-result-service.service */ "./src/app/request-result-service.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BasicMathComponent = /** @class */ (function () {
    ...
    BasicMathComponent.prototype.do_calculate = function () {
        var _this = this;
        this.service.fetchResult('basic_math/simplify', this.formula).then(function (result) {
    ...
    BasicMathComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_request_result_service_service__WEBPACK_IMPORTED_MODULE_1__["RequestResultServiceService"]])
    ], BasicMathComponent);
...
var CalculusComponent = /** @class */ (function () {
    function CalculusComponent(service) {
        this.service = service;
    }
    CalculusComponent.prototype.ngOnInit = function () {
        MathJax.Hub.Queue(['Typeset', MathJax.Hub]);
    };
    CalculusComponent.prototype.do_diff = function () {
        var _this = this;
        this.service.fetchResult('basic_math/diff', this.formula_diff).then(function (result) {
            var the_element = _this.diff_output.nativeElement;
            the_element.innerHTML = '$$ ' + result.result + ' $$';
            MathJax.Hub.Queue(['Typeset', MathJax.Hub]);
        });
    };
    CalculusComponent.prototype.do_integrate = function () {
        var _this = this;
        this.service.fetchResult('basic_math/integrate', this.formula_integrate).then(function (result) {
            var the_element = _this.integrate_output.nativeElement;
            the_element.innerHTML = '$$ ' + result.result + ' $$';
            MathJax.Hub.Queue(['Typeset', MathJax.Hub]);
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('diff_result'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], CalculusComponent.prototype, "diff_output", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('integrate_result'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], CalculusComponent.prototype, "integrate_output", void 0);
...
/***/ "./src/app/request-result-service.service.ts":
/*!***************************************************!*\
  !*** ./src/app/request-result-service.service.ts ***!
  \***************************************************/
/*! exports provided: RequestResultServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RequestResultServiceService", function() { return RequestResultServiceService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var RequestResultServiceService = /** @class */ (function () {
    function RequestResultServiceService(http) {
        this.http = http;
    }
    RequestResultServiceService.prototype.fetchResult = function (operator, formula) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.http.get('http://localhost:8000/' + operator, {
                                params: {
                                    'formula': [formula]
                                }
    ...
    RequestResultServiceService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], RequestResultServiceService);
    return RequestResultServiceService;
}());
